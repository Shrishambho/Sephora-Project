...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<MyErrorDetails> addressExceptionHandler(AddressException ex,WebRequest req){
	...
	public ResponseEntity<MyErrorDetails> ordersExceptionHandler(OrdersException ex,WebRequest req){
	...
	public ResponseEntity<MyErrorDetails> paymentsExceptionHandler(PaymentsException ex, WebRequest req){
		MyErrorDetails err = new MyErrorDetails();
		err.setTimestamp(LocalDateTime.now());
		err.setMessage(ex.getMessage());
		err.setDetails(req.getDescription(false));
