...
public class OrdersServiceImple implements OrdersService {
	...
	public Orders findbyOrderId(Integer orderId) throws OrdersException {
		log.info("Inside findbyOrderId method of OrdersServiceImple");
		...
		if(opt.isPresent()) {
			...
			log.debug("Returning Orders object from findbyOrderId method of OrdersServiceImple.");
			return orders;
		}
		else {
			
			log.error("Throwing exception from findbyOrderId method of OrdersServiceImple.");
	...
	public List<Orders> getOrderByCustomerId(Integer customerId) throws CustomerException {
		...
		log.info("Inside getOrderByCustomerId method of OrdersServiceImple");
		
		Optional<Customer> opt = customerRepository.findById(customerId);
		if(opt.isEmpty()) {
			
			log.error("Throwing exception from getOrderByCustomerId method of OrdersServiceImple.");
			throw new CustomerException("Customer with given id is not present");
		}
		else {
			...
			log.debug("Returning list of Orders from getOrderByCustomerId method of OrdersServiceImple.");
			return list;
		}
